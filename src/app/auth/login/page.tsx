                  ...
                  <div>
                    ...
                    <div className="mt-2">
                      <input
                        ...
                        required
                        autoComplete="email"
                        className="block w-full rounded-md border-0 py-1.5 px-3 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm leading-6"
                      />
                    </div>
                  </div>
